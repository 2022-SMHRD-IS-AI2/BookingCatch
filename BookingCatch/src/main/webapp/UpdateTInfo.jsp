            ...
            <div class="join">
                ...
                <form action="UpdateInfoCon" method="post" class="join-form" name="form" id="form">
                    ...
                    <div class="input-join">
                        <input type="text" value="접속중인 ID : <%=loginTrainer.getId()%>" readonly>
                        <input type="password" name="pw" placeholder="PW를 입력하세요">
                      	<input type="text" value="이름 : <%=loginTrainer.getName() %>" readonly> 
                        <input type="text" value="생년월일 : <%=loginTrainer.getBirth() %> " readonly>   
                        ...
                        <input name="center" type="text" placeholder="센터위치를 입력하세요" value="<%=loginTrainer.getCenter()%>">
                        <input name="ttype" type="text" placeholder="전공을 입력하세요 ex)헬스, 필라테스 등">
                        <input type="text" value="가입일자 : <%=loginTrainer.getB_date() %>" readonly>   
                        <input name="phone" type="text" placeholder="핸드폰번호를 입력하세요" value="<%=loginTrainer.getPhone()%>"></li>
                        <input type="text" value="성별 : <%=loginTrainer.getGender()%>">
