         ...
         <div class="sub-wrap">
            <div class="sub-content">
               <div class="sub-header">
                  <h3 class="sub_tit">트레이너 상세보기</h3>
               </div>
               <div class="sub-cont">
                  <div class="board-wrap">
                     <div class="board-view">
                        <div class="board-view_info">
                           <h3 class="subject">아름다운 오늘 ㅣ 시현하다와 함께한 장수사진 촬영</h3>
                           <div class="board-view_list">
                              <ul>
                                 <li>
                                    <span class="title">자료출처</span>
                                    <span class="text">플레이DB</span>
                                 </li>
                                 <li>
                                 ...
                                 <li>
                                    ...
                                    <span class="text">   2020.08.12</span>
                                 </li>
                                 <li>
                        ...
                        <div class="board-btn">
                           <button type="button" class="btn_list" title="목록">목록</button>
                        </div>
                     </div>
                  </div>
               </div>
