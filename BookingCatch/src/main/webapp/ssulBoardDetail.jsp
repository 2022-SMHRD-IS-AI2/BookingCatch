<%@page import="com.smhrd.model.ssulBoardVO"%>
<%@page import="com.smhrd.model.ssulBoardDAO"%>
...
<body>
	<%	
		...
		ssulBoardVO vo = new ssulBoardDAO().detailssulBoard(num);
                           ...
                           <div class="board-view_list">
                              <ul>
                                 ...
                                 <li>
                                    ...
                                    <span class="text"><a href="TrainerProfile.jsp">
	<%if(vo.getWriter()!=null){%><%=vo.getWriter() %> <%}
	else{%> <%=vo.getWriter2() %>
	<%}%>
									</a></span>
                                 </li>
                                 ...
                                 <li>
                                    ...
                                    <span class="text"><% out.print(0); //vo.getLikes() %></span>
                                 </li>
                              </ul>
                           </div>                           
                        </div>
