...
<body>
    	<div id="wrap">
                    ...
                    <article class="contents">
                        ...
                        <div class="login">
                            ...
                            <div class="profile">
                                <p>프로필 이미지</p>
                                <ul>
                                    <li><a href="#!" class="active" profile="1"><img src="img/profile/1.png" alt="man" width="100%"></a></li>
                                    <li><a href="#!" profile="2"><img src="img/profile/2.png" alt="woman" width="100%"></a></li>
                                    <li><a href="#!" profile="3"><img src="img/profile/3.png" alt="flower1" width="100%"></a></li>
                                    <li><a href="#!" profile="4"><img src="img/profile/4.png" alt="flower2" width="100%"></a></li>
                                    <li><a href="#!" profile="5"><img src="img/profile/5.png" alt="flower3" width="100%"></a></li>
                                </ul>
                                <!-- 프로필 이미지 선택 -->
                            </div>
                            <div class="name">
                                <label for="name">대화명</label>
                                <input class="name" type="text" id="name" value = id>
                            </div>
                        ...
                        <div class="talk_field">
                            ...
                            <div class="opponent_profile">
                                <ul>
                                    <li class="profile_img"><img src="img/chat.svg" alt="man" width="100%"></li>
    	  ...
    	  <script src="asset/js/errMsg.js"></script>
    	  <script src="asset/js/login2.js"></script>
    	  <script src="asset/js/vchatcloud.js"></script>
    </body>
</html>